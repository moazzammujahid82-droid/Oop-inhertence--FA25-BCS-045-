public class TestHospitalSystem {
    public static void main(String[] args) {
        ...
        doctor.display(); // Overridden in Doctor - calls super.displayInfo() first
        ...
        // System.out.println("Consultation fee (inherited calculation): $" +
        // surgeonConsultationFee);

        System.out.println("\n--- Testing Surgeon's own methods ---");
        // surgeon.performSurgery("Mike Brown");
        // double surgeryCost = surgeon.calculateSurgeryCost(3);
        // System.out.println("Surgery cost for 3 hours: $" + String.format("%.2f",
        // surgeryCost));
